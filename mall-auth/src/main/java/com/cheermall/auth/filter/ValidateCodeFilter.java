package com.cheermall.auth.filter;
...
import com.cheermall.common.entity.constant.GrantTypeConstant;
    ...
    protected void doFilterInternal(@Nonnull HttpServletRequest httpServletRequest, @Nonnull HttpServletResponse httpServletResponse, @Nonnull FilterChain filterChain) throws ServletException, IOException {
        ...
        if (matcher.matches(httpServletRequest)
            ...
            try {
                ...
                CheerMallUtil.makeResponse(httpServletResponse, MediaType.APPLICATION_JSON_VALUE,
                        HttpServletResponse.SC_INTERNAL_SERVER_ERROR, cheerMallResponse.message(e.getMessage()));
