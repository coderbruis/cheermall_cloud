...
import com.cheermall.auth.properties.ValidateCodeProperties;
import com.cheermall.auth.service.ValidateCodeService;
import com.cheermall.common.entity.constant.CheerMallConstant;
import com.cheermall.common.entity.constant.ImageTypeConstant;
import com.cheermall.common.entity.constant.ParamsConstant;
...
public class ValidateCodeServiceImpl implements ValidateCodeService {
    ...
    public void create(HttpServletRequest request, HttpServletResponse response) throws IOException, ValidateCodeException {
        ...
        redisService.set(CheerMallConstant.CODE_PREFIX + key, StringUtils.lowerCase(captcha.text()), code.getTime());
        captcha.out(response.getOutputStream());
    }

    @Override
    public void check(String key, String value) throws ValidateCodeException {
        Object codeInRedis = redisService.get(CheerMallConstant.CODE_PREFIX + key);
