package com.cheermall.auth.translator;
...
@Slf4j
@Component
public class MallWebResponseExceptionTranslator implements org.springframework.security.oauth2.provider.error.WebResponseExceptionTranslator {
    @Override
