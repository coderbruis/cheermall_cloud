package com.cheermall.gateway.handler;
 ...
 */
@Slf4j
public class CheerMallGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {
    public CheerMallGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
